...
(function () {
  ...
  function resolveToken(tokenPath, mode) {
    ...
    if (window.SEMANTIC && window.SEMANTIC[head]) {
      ...
      if (refs) return {
        hex: window.resolveRef(refs[mode]),
        base: baseFromRef(refs[mode])
      };
    }
  ...
  // ── Color normalization ────────────────────────────────────────────────
  // Canonicalize any CSS color string to a stable key:
  //   - opaque colors → "#RRGGBB" uppercase
  //   - translucent colors → "rgba(R, G, B, A)" matching the format stored
  ...
  // Walks up from `el` to the first element with a non-transparent
  ...
  // ── Row assembly ───────────────────────────────────────────────────────
  // Builds the rows shown in the TokenPill for `el`: declared data-tk-*
  // first, then a synthesized BG row from getComputedStyle (preferring
  // the declared token of the painting element, falling back to a
  ...
  function TokenPill() {
    ...
    useEffect(() => {
      ...
      const flush = () => {
        ...
        while (el && el.nodeType === 1 && el !== document.body) {
          const has = el.attributes && Array.from(el.attributes).some(a => a.name.indexOf("data-tk-") === 0);
          if (has) break;
          el = el.parentElement;
        }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, r.prop, r.source === "ancestor" ? /*#__PURE__*/React.createElement("span", {
        className: "tk-pill-inh",
        title: "Inherited from ancestor"
      }, " ↑") : null), /*#__PURE__*/React.createElement("span", {
        className: "tk-pill-token"
      }, r.token || "—"), /*#__PURE__*/React.createElement("span", {
        className: "tk-pill-hex"
      }, r.base && r.base !== r.token ? /*#__PURE__*/React.createElement("span", {
        style: {
          color: "#6A7280",
          marginRight: 8
        }
      }, r.base) : null, /*#__PURE__*/React.createElement("span", {
  ...
  const HouseLineIcon = p => /*#__PURE__*/React.createElement(PhosphorIcon, p, /*#__PURE__*/React.createElement("path", {
  ...
  const PaperPlaneTiltIcon = p => /*#__PURE__*/React.createElement(PhosphorIcon, p, /*#__PURE__*/React.createElement("path", {
  ...
  const EnvelopeIcon = p => /*#__PURE__*/React.createElement(PhosphorIcon, p, /*#__PURE__*/React.createElement("path", {
  ...
  const GearIcon = p => /*#__PURE__*/React.createElement(PhosphorIcon, p, /*#__PURE__*/React.createElement("path", {
  ...
  const SidebarSimpleIcon = p => /*#__PURE__*/React.createElement(PhosphorIcon, p, /*#__PURE__*/React.createElement("path", {
  ...
  const CaretDownIcon = p => /*#__PURE__*/React.createElement(StrokeIcon, _extends({}, p, {
    fill: "currentColor",
    stroke: "none"
  ...
  const ArrowRightIcon = ({ size = 20, ...rest }) => /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M224.49,136.49l-72,72a12,12,0,0,1-17-17L191,140H40a12,12,0,0,1,0-24H191L135.51,64.49a12,12,0,0,1,17-17l72,72A12,12,0,0,1,224.49,136.49Z"
  }));
  const CheckIcon = p => /*#__PURE__*/React.createElement(StrokeIcon, p, /*#__PURE__*/React.createElement("polyline", {
    points: "5 12 10 17 19 8"
  }));
  const PlayIcon = p => /*#__PURE__*/React.createElement(StrokeIcon, _extends({}, p, {
    fill: "currentColor",
    stroke: "none"
  }), /*#__PURE__*/React.createElement("polygon", {
  ...
  function TalinDocumentationIcon({
    size = 32
  }) {
    return /*#__PURE__*/React.createElement("svg", {
      width: size,
  ...
  function MailboxRow() {
    ...
    }, /*#__PURE__*/React.createElement(MailboxStackIcon, null)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "ex-setup-title",
      "data-tk-fg": "fg",
      style: {
        color: "var(--fg)"
      }
    }, "Connect a mailbox"), /*#__PURE__*/React.createElement("div", {
      className: "ex-setup-sub",
      "data-tk-fg": "fg.muted",
      style: {
        color: "var(--fg-muted)"
      }
    }, "Connect your email to send personalized outreach and track replies")), /*#__PURE__*/React.createElement("span", {
      style: {
        color: "var(--fg-muted)"
      }
    }, /*#__PURE__*/React.createElement(CaretDownIcon, {
  ...
  function CampaignOption({
    ...
    }, footPrefix, " ", /*#__PURE__*/React.createElement("span", {
      style: {
        color: "var(--fg)",
        fontWeight: 600
      }
  ...
  function ExampleHome() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "ex-brand-row"
    }, !sidebarCollapsed && /*#__PURE__*/React.createElement(TalinLogo, null), /*#__PURE__*/React.createElement("button", {
      type: "button",
    ...
    }, /*#__PURE__*/React.createElement(SidebarSimpleIcon, {
      size: 20
    }))), /*#__PURE__*/React.createElement("div", {
      ...
      size: 16
    })), /*#__PURE__*/React.createElement("span", null, "Search")), /*#__PURE__*/React.createElement("nav", {
      className: "ex-side-nav"
    ...
    }, "John Smith"), /*#__PURE__*/React.createElement("div", {
    ...
    }, "m@example.com")), !sidebarCollapsed && /*#__PURE__*/React.createElement("span", {
      "data-tk-fg": "fg.muted",
      style: {
        color: "var(--fg-muted)",
        display: "inline-flex"
    ...
    }, "Good afternoon, Ivan"), /*#__PURE__*/React.createElement("div", {
      className: "ex-home-grid",
      style: {
        gap: 32
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "Setup guide"), /*#__PURE__*/React.createElement("span", {
      style: {
        display: "inline-flex",
        alignItems: "center",
        gap: 6,
    ...
    }, /*#__PURE__*/React.createElement(ProgressArc, {
      value: 1 / 3
    }), /*#__PURE__*/React.createElement("span", null, "1/3"))), /*#__PURE__*/React.createElement("div", {
      className: "ex-card",
      "data-tk-bg": "bg.panel",
      "data-tk-border": "border",
      style: {
    ...
    }), /*#__PURE__*/React.createElement(MailboxRow, null))), /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h2", {
      className: "ex-h2",
      "data-tk-fg": "fg",
      style: {
        color: "var(--fg)",
    ...
    }, "Create your first campaign"), /*#__PURE__*/React.createElement("div", {
      className: "ex-pair"
    }, /*#__PURE__*/React.createElement(CampaignOption, {
      icon: RecruitCandidatesIcon,
      title: "Recruit candidates",
      footPrefix: "Found on",
      foot: "peakdemandinc.com",
      rows: [{
        title: "Solar Project Managers",
        sub: "5+ yrs · Utility scale projects · Oakland, CA"
      }, {
        title: "Sales Engineers",
        sub: "3+ yrs · EPC companies · Santa Cruz, CA"
      }, {
        title: "Construction Managers",
        sub: "7+ yrs · Utility scale solar projects · Phoenix, AZ"
      }]
    }), /*#__PURE__*/React.createElement(CampaignOption, {
      ...
      foot: "peakdemandinc.com",
      rows: [{
        title: "VPs of Construction",
        sub: "Utility-scale solar developers · Oakland, CA"
      }, {
        title: "Heads of Sales",
        sub: "Solar module & inverter manufacturers · Santa Cruz, CA"
      }, {
        title: "COOs / VPs of Field Operations",
        sub: "Renewable IPPs"
      }]
    })))), /*#__PURE__*/React.createElement("div", {
      style: {
